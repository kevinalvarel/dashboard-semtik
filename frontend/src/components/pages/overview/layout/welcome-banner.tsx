...
export function WelcomeBanner() {
  return (
    <div className="relative overflow-hidden rounded-2xl bg-primary p-4 sm:p-6 text-primary-foreground shadow-sm">
      <div className="relative z-10 flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div>
          <h1 className="text-xl font-bold tracking-tight sm:text-2xl md:text-3xl">
            Atmin Dashboard
          </h1>
          <p className="mt-1 text-primary-foreground/80 max-w-2xl text-xs sm:text-sm md:text-base">
        ...
        <div className="flex shrink-0 gap-2 w-full sm:w-auto">
          <Link to="/scan-qr" className="w-full sm:w-auto">
            <Button className="w-full sm:w-auto bg-primary-foreground text-primary hover:bg-primary-foreground/90 border-0 font-medium">
